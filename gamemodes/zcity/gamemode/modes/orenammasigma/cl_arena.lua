...
net.Receive("arena_start", function()
    zb.RemoveFade()
end)
...
local teams = {
	...
	[1] = {
		objective = "",
		name = "Blue",
		color1 = Color(0,0,190),
		color2 = Color(0,0,190)
	},
}
...
function MODE:HUDPaint()
    for i, ply in player.Iterator() do
		...
		surface.SetTextColor(ply:Team() == 1 and Color(0,0,140)  or Color(220,0,0))
		surface.SetFont("ScoreboardDefault")
		local txt = ply:Name()
		local w, h = surface.GetTextSize(txt)
		surface.SetTextPos(posscr.x - w / 2, posscr.y - h * 0.5 - height)
    ...
    draw.SimpleText("Homicide | Arena", "ZB_HomicideMediumLarge", sw * 0.5, sh * 0.1, Color(0,162,255, 255 * fade), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)
...
net.Receive("arena_roundend",function()
    CreateEndMenu()
end)
