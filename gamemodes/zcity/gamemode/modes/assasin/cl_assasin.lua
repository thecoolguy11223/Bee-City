...
local assasin = {
	objective = "Find your victims and kill them. You might be the victim of it.",
	name = "an Assasin",
...
function MODE:HUDPaint()
    ...
    draw.SimpleText("Homicide | Assasin", "ZB_HomicideMediumLarge", sw * 0.5, sh * 0.1, Color(0,162,255, 255 * fade), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)
    local Rolename = assasin.name
    local ColorRole = assasin.color1
    ColorRole.a = 255 * fade
    draw.SimpleText("You are "..Rolename , "ZB_HomicideMediumLarge", sw * 0.5, sh * 0.5, ColorRole, TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)

    local Objective = assasin.objective
    local ColorObj = assasin.color2
    ColorObj.a = 255 * fade
